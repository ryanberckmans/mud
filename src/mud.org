...
** TODO groups, and groups are constant across all worlds             :STORY:
** TODO Commands, using the check/groups system we talked about       :STORY:
** TODO commands exist and wrap callbacks in validation chain         :STORY:
** TODO commands have list of allowed/denied groups                   :STORY:
